...
class AverageDistanceSolver(Solver):
    ...
    def solve(self, problem):
        ...
        while problem.any_location_unvisited():
            route_id += 1
            route = Route(route_id, problem.vehicle_capacity)
        ...
        self.write_solution_file("average_distance/", problem.file_name.replace(".vrp", ".txt"))
        return Solution(self.routes, self.total_cost, "average_distance/" + problem.file_name.replace(".vrp", ".txt"))
